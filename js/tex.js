...
/*
  ...
  11. swiper slider
	...
	11.2. swiper works slider
  12. magnificPopup
    12.1. magnificPopup works gallery
  13. facts counter
  14. skills bar
*/
...
$(function() {
    ...
    $(window).on("scroll", function() {
        ...
        // 6. home fadeOut animation
        $("h1.home-page-title, h2.home-page-title, .the-button-wrapper, .social-icons-wrapper, .copyright-home").css("opacity", 1 - $(window).scrollTop() / 500);
    })
    ...
    // 11.2. swiper works slider
    var textBottom = new Swiper(".works-bottom", {
        a11y: true,
        spaceBetween: 0,
        slidesPerView: 1,
        loop: true,
    ...
    var galleryTop = new Swiper(".works-top", {
        a11y: true,
        spaceBetween: 0,
        loop: true,
        fadeEffect: {
        ...
        navigation: {
            nextEl: ".swiper-container-works .swiper-button-next",
            prevEl: ".swiper-container-works .swiper-button-prev",
        },
        pagination: {
            el: ".swiper-container-works .swiper-pagination",
            type: "bullets",
        },
        thumbs: {
            swiper: textBottom,
